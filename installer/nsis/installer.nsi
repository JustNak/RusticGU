; RusticGU NSIS template for cargo-packager.
; Based on cargo-packager 0.11.x default installer.nsi (app + updater only).
;
...
; Task Manager / Explorer show "RusticGU" (not a marketing sentence).
